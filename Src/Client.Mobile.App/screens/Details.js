      ...
      <View style={styles.ContentContainer}>
        <View style={{ ...styles.ItemAreaContent, flex: 2 }}>
          <View>
            <View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", marginVertical: 10 }}>
              <View>
                <Text style={{ ...styles.ItemText }}>Mã: 012345 </Text>
              </View>
              <View>
                <Text style={{ ...styles.ItemText }}>Ngày: [ngày giờ]</Text>
              </View>
            </View>

            <View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", marginVertical: 10 }}>
              <View>
                <Text style={{ ...styles.ItemText }}>Trạng thái: đang xử lý </Text>
              </View>
            </View>
            <View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", marginVertical: 10 }}>
              <View>
            ...
            <View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", marginVertical: 10 }}>
              <View>
                <Text style={{ ...styles.ItemText }}>10 Đinh Bộ Lĩnh, Phường 24, Quận</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={{ ...styles.ItemAreaContent, flex: 3, paddingHorizontal: 0, }}>
          <View style={{ padding: 10 }}>
            ...
            <Text style={{ marginBottom: 10 }}>Điện - Thay mới thiết bị</Text>
            <Text style={{ marginBottom: 10 }}>Nước - Hỗ trợ tư vấn</Text>
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.tabBarInfoBottomContainer}>
          ...
          <View style={styles.ButtonContainer}>
            <Button
              containerStyle={{ ...styles.BtnContainer, backgroundColor: "red" }}
