...
export default class StepOneScreen extends React.Component {
  static navigationOptions = ({ navigation, screenProps }) => ({
    ...
    headerLeft: () => <Ionicons style={{ marginLeft: 10 }} name={
                                ...
                                size={35} onPress={() => { navigation.goBack() }} />,
    headerRight: <Text style={{ fontWeight: "bold", marginRight: 10 }}>1/2</Text>,
  });
